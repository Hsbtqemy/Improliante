...
### Arbitrages
- [ ] Trancher le doublon entre le groupe « Réglages » du rail et la barre d'onglets des quatre écrans : ce sont **les mêmes quatre destinations, affichées deux fois côte à côte**. Les trois autres domaines à plusieurs écrans font l'inverse — Facturation (Devis/Factures/Avoirs/Clients), Budget (Mouvements/Bilan/Saisons/Catégories) et Cotisations (Adhésions/Reçus) ont **une** entrée de rail et laissent les onglets faire le reste. Soit « Réglages » devient une entrée unique comme elles, soit la barre d'onglets disparaît. La première option est celle du dépôt, mais elle ferait de « Réglages » une seconde entrée hors groupe, à côté de « Vue d'ensemble » — le rail approuvé le donnait comme groupe, ce n'est donc pas à l'agent d'en décider
