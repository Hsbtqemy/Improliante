...
| GOU-01 | ✅ | P1 — le résultat d'une réunion doit être figé avec ses règles | **Le contenu est scellé** (lot 12) : une réunion archivée refuse résolution, point d'ordre du jour, présence, pouvoir et réécriture du compte rendu — règle relue sous verrou dans le service, écrans qui n'offrent plus les formulaires, admin aligné (inlines en lecture seule, décompte des voix et notes figés, rattachement refusé). Le PV se régénère encore et la séance se rouvre par son statut : exprès, une clôture par erreur doit se défaire. Les règles étaient figées au lot 4 (`d1ba3a5`), avec le registre électoral, et le gel vaut sur les trois chemins de clôture depuis la relecture du lot 12. Dernière pièce (lot 14) : `PouvoirInline` est en lecture seule — il écrivait des pouvoirs sans le plafond statutaire ET sans inscrire la présence du mandant ; le retrait, qui n'existait que là, est rendu à l'écran du bureau |
| ARCH-01 | ✅ | P1 — les règles centrales restent trop dépendantes des vues | **Inventaire fait** (lot 10) : [`regles-hors-services.md`](regles-hors-services.md), sept points, dont trois pesant plus que le constat d'origine. Les trois sont corrigés : le devis refacturable (lot 11, point 3), la réunion archivée avec son compte rendu écrit hors formulaire (lot 12, points 2 et 5), et le PV régénéré qui détruisait le précédent (lot 13, point 1). `PouvoirInline` a suivi (lot 14, point 4), et le point 6 a été **tranché par l'association** le 13 septembre (lot 15) : une adhésion dont un reçu a été émis ne se supprime plus, les transactions restant détachées. Le septième point est laissé tel quel à dessein — la règle y est au bon endroit |
