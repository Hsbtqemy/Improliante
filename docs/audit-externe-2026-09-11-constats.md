...
| ARCH-01 | 🟠 | P1 — les règles centrales restent trop dépendantes des vues | **Inventaire fait** (lot 10) : [`regles-hors-services.md`](regles-hors-services.md), sept points, dont trois pesant plus que le constat d'origine. Deux des trois sont corrigés : le devis refacturable (lot 11, point 3) et la réunion archivée avec son compte rendu écrit hors formulaire (lot 12, points 2 et 5). **Restent** : le PV régénéré qui détruit le précédent (point 1), `PouvoirInline` (point 4), et l'arbitrage sur la suppression d'une adhésion portant un reçu émis (point 6) |
