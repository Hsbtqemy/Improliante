...
| FRONT-07 | 🟠 | P1/P2 — finir les parcours d'accès et de réservation | Ouvert : aucun parcours « mot de passe oublié ». Décidé (12 sept.) de l'écrire avec le backend console, le SMTP venant au déploiement |
| FRONT-08 | 🟠 | P1/P2 — corriger les entrées invalides et vérifier l'accessibilité réelle | **Partiel** : l'erreur 500 du calendrier est corrigée (lot 1). La campagne reste entière, et couvre les 18 palettes depuis que FRONT-03 est écarté. Décidé : corriger d'abord ce qui se vérifie sans navigateur, puis une passe QA |
| OPS-01 | 🟠 | P1 — le déploiement n'attend pas une validation distante du commit | Ouvert : décidé (12 sept.) d'écrire la vérification distante sur PostgreSQL dès maintenant ; le branchement du webhook sur son succès reste à DEP-1 |
